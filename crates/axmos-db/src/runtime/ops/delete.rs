use crate::{
    ...
    runtime::{
        ...
        TypeSystemError, context::TransactionContext,
    },
    ...
    Child: RunningExecutor,
{
    ...
    fn delete_row(&mut self, row: &Row) -> RuntimeResult<bool> {
        ...
        btree.update(root, deleted, &schema)?;
